...
static constexpr uint32_t BUF_DIR_PIN_MASK = 1 << BUF_OE_PIN;

static constexpr uint32_t RESET_PIN = 28;
static constexpr uint32_t RESET_PIN_MASK = 1 << BUF_OE_PIN;

static constexpr uint32_t INFO_LED_PIN = 29;
static constexpr uint32_t INFO_LED_PIN_MASK = 1 << BUF_OE_PIN;
