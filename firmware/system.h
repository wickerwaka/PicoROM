...
static constexpr uint32_t DATA_PIN_MASK = 0xff << BASE_DATA_PIN;
static constexpr uint32_t BUFFER_PIN_MASK = 0x1 << BASE_BUF_OE_PIN;
static constexpr uint32_t OE_PIN_MASK = 0x3 << BASE_OE_PIN;
